...
const config: Config = {
  content: [
    ...
    "./node_modules/@nextui-org/theme/dist/components/(button|input|navbar|select|table|ripple|spinner|listbox|divider|popover|scroll-shadow|checkbox|spacer).js",
  ],
  theme: {
    extend: {
      colors: {
