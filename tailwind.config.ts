...
const config: Config = {
  content: [
    ...
    "./node_modules/@nextui-org/theme/dist/components/(button|checkbox|date-picker|divider|input|modal|navbar|select|table|ripple|spinner|calendar|date-input|popover|listbox|scroll-shadow|spacer).js",
  ],
  theme: {
    extend: {
      colors: {
