...
const config: Config = {
  content: [
    ...
    "./node_modules/@nextui-org/theme/dist/components/(button|checkbox|input|navbar|select|table|ripple|spinner|listbox|divider|popover|scroll-shadow|spacer).js",
  ],
  theme: {
    extend: {
      colors: {
